...
[![arXiv](https://img.shields.io/badge/arXiv-1812.06976%20-green.svg)](https://arxiv.org/abs/1812.06976)
...
XMM-DM is a repository containing the data-reduction code used in [1812.06976](https://arxiv.org/abs/1812.06976), and the supplementary data for the analysis.
...
A central aspect of the analysis performed in [1812.06976](https://arxiv.org/abs/1812.06976) was processing a large number of XMM-Newton datasets. In `ProcessXMM` we provide the code written for this purpose.
...
## Supplementary Data for [1812.06976](https://arxiv.org/abs/1812.06976)

In `SuppData/Fiducial_Exposures.csv` we provide the full list of 1,397 exposures used in the fiducial 3.5 keV line analysis of [1812.06976](https://arxiv.org/abs/1812.06976). For each exposure, the following information is provided: 
